...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        //json
//        NSString *jsonString = @"{\"username\":\"张三\",\"age\":18}";
        ...
        //json映射
//        [userModel zxp_setValuesWithJSONString:jsonString error:nil];
        
        //如果映射的model里包含了其他model，可以使用以下方法为包含的model提供映射，推荐在model的初始化方法里使用
        //[userModel zxp_setObjectClassForObject:@{@"otherInfo":[OtherModel class]}];
...
//        [userModel zxp_setObjectClassInArray:@{@"otherInfos":[OtherModel class]}];
        ...
        NSLog(@"username:%@,age=%zi,height=%f",userModel.username,userModel.age,userModel.height);
